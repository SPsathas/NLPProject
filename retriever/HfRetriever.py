...
class HfRetriever(BaseRetriver):
    ...
    def encode_queries(self,
        ...
        with torch.no_grad():
            tokenized_questions = self.question_tokenizer([query.text() for query in queries], padding=True,
    ...
    def encode_corpus(self,
        ...
        with torch.no_grad():
            while index < len(contexts):
                ...
                tokenized_contexts = self.context_tokenizer(samples, padding=True, truncation=True,
    ...
    def load_index_if_available(self) -> Tuple[Any, bool]:
        if os.path.exists(
                "C:/Users/matte/OneDrive - Politecnico di Milano/Poli/Erasmus/Corsi/Natural Language Processing/group project/indices/corpus/index"):
